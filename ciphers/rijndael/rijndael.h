 ...
 *
 * Added AES modes of operation implementation by Zoresvit <zoresvit@gmail.com>
 * 2010
 */
...
#define AES_GEN       0x03   // gf(2^8) generator mod(x^4 + 1)
...
typedef struct 
{
    ...
    int kcol;   /* number of 32 bit words comprising Cipher Key */
    unsigned int rounds;
    unsigned int* keysched; /* scheduled round keys array */
    unsigned char iv[16];
} aes_ctx_t;
