...
class Gost:
    ...
    def polynomial_system(self):
        ...
        Returns:
            ...
            object constructed from the polynomials that fully describe GOST
            encryption. Round polynomials are stored in a sublist so one
            can get the round polynomials with 
